		...
		">
			<div class="yith-wcwl-popup-content">
				...
				<p class="form-row">
					...
					echo wp_kses_post( sprintf( __( 'This item is already in the <b>%s moodboard</b>.<br/>You can move it to another list:', 'yith-woocommerce-wishlist' ), $found_in_list->get_formatted_name() ) );
					?>
				</p>
			...
			<div class="yith-wcwl-popup-footer">
				<a
					...
					rel="nofollow"
				>
					<?php echo wp_kses_post( apply_filters( 'yith_wcwl_move_label', __( 'Move', 'yith-woocommerce-wishlist' ) ) ); ?>
				</a>
